...
<Tabs>
  <Tab title="YAML (Composer)">
    ...
    The REPL drops you into an interactive session with your agent. Type a question, watch the stream. `/help` lists the slash commands; `/exit` when done.
